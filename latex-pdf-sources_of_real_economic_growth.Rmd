...
If you'd just like the LaTeX code, for example to paste that into a separate LaTeX document, use `cat()`, see below. Use `as.character()` instead of `cat` if you'd like this in a single line. 
